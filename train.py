...
def main():
    ...
    best_cv_model.save_model('models/xgboost/without_ptms/split_all/best_cv_model.json')
    print("\nBest model from CV saved to 'models/xgboost/without_ptms/split_all/best_cv_model.json'")
    ...
    final_model.save_model('models/xgboost/without_ptms/split_all/final_model.json')
    print("Final model trained on all data saved to 'models/xgboost/without_ptms/split_all/final_model.json'")
